...
<title>update breakfast meals</title>
...
<a href="logout.php" >log out!</a>
 <br /><br /><br /><br />
  ...
  </div><div align="center" id="rightpane" align="center" >
 <nav>
  <ul >
...
echo "<table border='0' align='center' cellspacing='1' cellpadding='1'><tr><th bgcolor='#FFFFFF'>LIST</th><th bgcolor='#FFFFFF'>FOOD</th><th bgcolor='#FFFFFF'> AVAILABLE</th><th bgcolor='#FFFFFF'> NOT AVAILABLE</th></tr>";

while($row=mysql_fetch_array($result))

{
	echo "<form action='updatebreakfast.php' method='post'   onsubmit='return kip(this)'>";
	...
	echo "<td><input type='submit' name='submit' value='availabe'></td>";
	echo "<td><input type='submit' name='submit1' value='not available'  ></td></tr>";	
