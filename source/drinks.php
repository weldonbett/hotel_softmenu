...
$result=mysql_query("SELECT * FROM drinks WHERE xxx= '1' ORDER BY food");


 echo "<table border='0' align='center' cellspacing='1' cellpadding='1'><tr><th  bgcolor='#FFFFFF' align='left' >DRINKS</th><th bgcolor='#FFFFFF' align='left'>PRICE(ksh)</th><th bgcolor='#FFFFFF' align='left'>QUANTITY</th><th bgcolor='#FFFFFF'  align='left'>CHAIR NO.</th> <th bgcolor='#FFFFFF'>  </th>  <th  bgcolor='#FFFFFF'> </th></tr> ";
...
{
	echo "<form action='drinks.php' method='post' onsubmit='return kip(this)'>" ;
