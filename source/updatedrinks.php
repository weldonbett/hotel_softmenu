...
<a href="logout.php" >log out!</a> 
 ...
 <br /><br /><br /><br />
  ...
  </div><div id="rightpane" align="center"><nav>
  <ul >
...
echo "<table border='0' align='center' cellspacing='1' cellpadding='1'><tr><th bgcolor='#FFFFFF'>LIST</th><th bgcolor='#FFFFFF'>FOOD</th><th bgcolor='#FFFFFF'>AVAILABLE</th><th bgcolor='#FFFFFF'>NOT AVAILBALE</th></tr>";

while($row=mysql_fetch_array($result))

{
	echo "<form action='updatedrinks.php' method='post'    onsubmit='return kip(this)'>";
