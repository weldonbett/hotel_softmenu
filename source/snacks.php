...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    </head><body bgcolor="#FFFFFF"><div id="header"> 
...
<ul><li><a href="index.php" style="text-decoration:none">Exit &nbsp; &nbsp;  &nbsp; &nbsp;</a></li></ul>
                ...
                $result = mysql_query("SELECT*FROM snacks WHERE xxx= '1' ORDER BY food");
           
 echo "<table border='0' align='center' cellspacing='1' cellpadding='1'><tr><th  bgcolor='#FFFFFF' align='left' >SNACKS</th><th bgcolor='#FFFFFF' align='left'>PRICE(ksh)</th><th bgcolor='#FFFFFF' align='left'>QUANTITY</th><th bgcolor='#FFFFFF'  align='left'>CHAIR NO.</th> <th bgcolor='#FFFFFF'>  </th>  <th  bgcolor='#FFFFFF'> </th></tr> ";
...
{
	echo "<form action='snacks.php' method='post' onsubmit='return kip(this)'>" ;
