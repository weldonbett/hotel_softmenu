...
<table><tr><td>
 <nav>
  ...
  <ul >
  <li> <a href="breakfast.php" style="text-decoration:none"> Breakfast
 </a>
					   </li></ul>
...
<ul><li><a href="index.php" style="text-decoration:none">Exit &nbsp; &nbsp;  &nbsp; &nbsp;</a></li></ul>
            ...
            <div id="rightpane">
                ...
                $result = mysql_query("SELECT*FROM cuttlery WHERE sss= '1' ORDER BY spoons");
           

                echo "<table border='0' align='center' cellspacing='1' cellpadding='1'><tr><th  bgcolor='#FFFFFF' align='left'>CUTTLERIES</th>     <th  bgcolor='#FFFFFF' align='left'>CHAIR NO.</th>  <th  bgcolor='#FFFFFF'> </th>   <th  bgcolor='#FFFFFF'> </th></tr> ";
...
{
	echo "<form action='spoons.php' method='post' onsubmit='return kip(this)'>" ;
	echo "<input type='hidden' name='spoons' value='".$row['spoons']."'>";
	
	echo "<tr><td>".$row['spoons']."</td>";
...
?>
 ...
 <br /><br />
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert = "INSERT INTO orders VALUES('', '$spoons',  '$tableno','$serve')";
